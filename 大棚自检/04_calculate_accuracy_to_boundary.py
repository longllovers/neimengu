...
TRUTH_CODE_FIELD = "CLTBEJLDM"
MEASURE_CODE_FIELD = "TBEJLDM"
...
METRIC_FIELD_PATTERN = re.compile(r"^(MA|IoU|LR|CR)(.+)$", re.IGNORECASE)
DEFAULT_MA_CAP_CODE = ""
DEFAULT_MA_CAP_MAX = None
EXCLUDED_OUTPUT_CODES: set[str] = set()
REQUIRED_OUTPUT_CODES: set[str] = {"801"}
...
def parse_args() -> argparse.Namespace:
    ...
    parser.add_argument("--mode", choices=("skip", "overwrite"), default="overwrite", help="skip 跳过已有 MA/IoU 的区县；overwrite 重算并覆盖已有精度。")
