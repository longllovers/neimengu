...
def main() -> None:
    ...
    for index, admin_unit in enumerate(admin_units, start=1):
        ...
        try:
            ...
            has_target_crop = generate_for_admin_unit(admin_unit, classification_gdf, output_root, args, rng)
            success_count += 1
            print(
            ...
            if has_target_crop:
                crop_region_count += 1
                crop_regions.append(f"{city_name}-{county_name}")
